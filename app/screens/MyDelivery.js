...
const MyDelivery = () => {
  console.log("here My deliveries");
  ...
  return (
    <Screen style={tw`bg-white h-full`}>
      ...
      <View style={tw`p-5`}>
        <Text style={styles.title2}>Your Food Orders</Text>
      </View>
      <View
        style={tw`p-2 pb-4 pt-4 bg-gray-200 mr-4 mb-6 ml-4 rounded-lg flex-row justify-center items-center`}
      >
        <Text style={tw`text-lg mr-6`}>Add a new order</Text>
        {/* <AntDesign
          name="plus"
          size={24}
          color="black"
